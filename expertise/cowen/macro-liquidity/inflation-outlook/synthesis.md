...
CPI, PPI, and forward inflation expectations. Cowen uses inflation trajectory as the primary constraint on Fed cuts and the key signal for whether monetary policy can ease.
...
- Headline CPI rose to 3.78% YoY, above the 3.6–3.7% consensus, with housing (3.37%→3.63%) and transportation (6.89%) as primary drivers (Rf-gAQJk5-0)
- Core CPI is at 2.74%, up from a February trough of 2.47%, suggesting inflation is reversing rather than converging to the 2% target (Rf-gAQJk5-0)
...
- 2026-05-25 (dy3E7Jzte88): Market is now pricing rate hikes rather than cuts — Cowen calls this straightforwardly bearish for crypto; elevated energy prices are the driver, with structural risk of another energy price leg higher in Q3 that would extend BTC bear headwinds through year-end.
- 2026-05-21 (mwrgOz852wI): Rate-cut expectations priced in at the start of 2026 have been fully priced out and markets are now pricing hike risk; Cowen frames this monetary tightening as the primary driver of ETH/BTC ratio deterioration and flags a potential BoJ June hike as a near-term liquidation catalyst.
- 2026-05-15 (FgxAe_NAh5c): CPI reaccelerating YoY and PPI spiking (~6% MoM) make Fed cuts impossible; rates expected to hold through summer 2026 with hike risk in 2027.
- 2026-05-12 (Rf-gAQJk5-0): Headline CPI printed 3.78% on a supply-side energy shock; core CPI reversed its downtrend; markets fully priced out all 2026–2027 cuts and now price a 2027 hike as more likely than a cut; Cowen introduces the "Fed checkmate" thesis as the dominant late-cycle structural risk.
